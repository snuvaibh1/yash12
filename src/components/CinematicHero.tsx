  ...
  return (
    <section ref={containerRef} className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
        ...
        >
            <motion.div
              className="relative w-[26rem] h-[26rem] sm:w-96 sm:h-96 md:w-[32rem] md:h-[32rem] lg:w-[40rem] lg:h-[40rem] xl:w-[48rem] xl:h-[48rem] flex items-center justify-center translate-y-[-2rem] sm:translate-y-0"
              whileHover={{
                scale: 1.05,
