...
const DumbbellSection: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Designed as per your eating habits, ethnicity, availability of ingredients, intolerances, cravings patterns, etc.',
      position: 'top-right',
    },
    {
      title: '24/7 Support',
      description:
        'If you are a premium member, feel free to call anytime. If you are a standard member then 24/7 WhatsApp support. I am always one message away.',
